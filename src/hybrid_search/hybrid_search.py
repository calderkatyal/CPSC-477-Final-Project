...
from src.hybrid_search.combine_rankings import combine_rankings
...
def main():
    ...
    while True:
        ...
        semantic_rankings, keyword_rankings = search_results
        combined_rankings = combine_rankings(semantic_rankings, keyword_rankings, len(query), num_emails, num_results_wanted)
        print("Results for "+folder+", email ids and their scores: ")
